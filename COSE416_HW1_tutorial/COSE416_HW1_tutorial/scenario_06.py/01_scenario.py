...
# PCD 처리 및 필터링 기준 설정
voxel_size = 0.05
min_points_in_cluster = 40
max_points_in_cluster = 90
min_z_value = 0.0
max_z_value = 6.0
min_height = 0.3
max_height = 2.5
...
# 동영상 저장 설정
output_video_path = "01_output_video.avi"  # 동영상 파일 경로
...
if __name__ == "__main__":
    ...
    pcd_folder_path = "C:/Users/estre/Downloads/COSE416_HW1_data_v1/data/01_straight_walk/pcd"
