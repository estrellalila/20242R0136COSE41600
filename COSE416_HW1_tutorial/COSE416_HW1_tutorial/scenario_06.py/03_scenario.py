...
max_ratio = 3.0
threshold_ratio = 3.0
FRAME_INTERVAL = 0.2  # 1초에 10프레임

# 동영상 저장 설정
output_video_path = "03_output_video.avi"  # 동영상 파일 경로
...
def process_pcd(file_path):
    ...
    cl, ind = downsample_pcd.remove_statistical_outlier(nb_neighbors=10, std_ratio=6.0)
    sor_pcd = downsample_pcd.select_by_index(ind)

    # 평면 추정 및 제거
    plane_model, inliers = sor_pcd.segment_plane(distance_threshold=0.2, ransac_n=5, num_iterations=3000)
    ...
    clusterer = hdbscan.HDBSCAN(min_cluster_size=20, min_samples=13, cluster_selection_epsilon=0.2, allow_single_cluster=False)
...
if __name__ == "__main__":
    ...
    pcd_folder_path = "C:/Users/estre/Downloads/COSE416_HW1_data_v1/data/03_straight_crawl/pcd"
